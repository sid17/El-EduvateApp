...
<div id="header" class="component">
	...
	<a href="https://www.google.com" class="exclusive-learning_classroom" tag_category="header" tag_action="click" tag_label = "classroom">
...
<center>
<form name=Flash>
<font class=Sign>Pronunciation</font><br>
...
var img=document.getElementById("Ans"+CPick);
